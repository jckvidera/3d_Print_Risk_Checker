...
page = st.sidebar.selectbox(
    "Choose a page",
    ["Home", "Carlos Prototype", "Teammate Prototype"]
)
...
if page == "Home":
    ...
    st.write("Teammate Prototype is a separate page for other team work.")
...
elif page == "Teammate Prototype":
    st.title("Teammate Prototype")
    st.write("This page shows my teammate's separate prototype work.")

    teammate_file = st.file_uploader(
        "Upload teammate prototype file",
        type=["gcode", "txt", "bgcode"],
        key="teammate_upload"
    )
    ...
    if teammate_file is not None:
        ...
        st.write("Add teammate-specific charts, explanation, or features here.")